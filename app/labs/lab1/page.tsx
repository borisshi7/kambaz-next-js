    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Halve, stone, peel and slice the avocados.</li>
          <li>
            Halve and quarter the cucumber lengthways, then cut into slices.
          </li>
          <li>
            Divide salad, avocado and cucumber between four plates, then drizzle
            with half the dressing.
          </li>
          <li>Heat a non-stick pan.</li>
          <li>
            Add the salmon and fry for 3-4 mins on each side until crisp but
            still moist inside.
          </li>
          <li>
      ...
      <br /> <input type="checkbox" name="check-genre" id="wd-chkbox-fantasy" />
